...
public:
	...
	// 인벤토리 조작 API
	void AddItemToInventory(class UNAInventoryComponent* InInventory,const FName& SlotID, UNAItemData* ItemData);
	UNAItemData* RemoveItemFromInventory(UNAItemData* ItemData);

protected:
	virtual void Initialize(FSubsystemCollectionBase& Collection) override;
	virtual void Deinitialize() override;
	
	bool MakeSlotData(UNAInventoryComponent* InInventory, const FName& SlotID, const UNAItemData* ItemData, FNAInventorySlot& OutSlotData);
...
private:
	...
	// 아이템 데이터, 슬롯 데이터
	UPROPERTY()
	TMap<TWeakObjectPtr<UNAItemData>, FNAInventorySlot> InventoryItems;

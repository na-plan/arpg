...
void UNAAssetGameInstanceSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	if (UDataTable* DataTable = Cast<UDataTable>(StaticLoadObject(UDataTable::StaticClass(), nullptr, TEXT("/Script/Engine.DataTable'/Game/00_ProjectNA/03_DataTable/00_Assets/AssetsTable.AssetsTable'"))))
	{

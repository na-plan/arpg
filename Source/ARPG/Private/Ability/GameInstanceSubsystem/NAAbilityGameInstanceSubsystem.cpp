...
void UNAAbilityGameInstanceSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	if (UDataTable* DataTable = Cast<UDataTable>(StaticLoadObject(UDataTable::StaticClass(), nullptr, TEXT("/Script/Engine.DataTable'/Game/00_ProjectNA/01_Blueprint/05_DataTables/Ability/AttributesTable.AttributesTable'"))))
	{

...
void UNAAbilityGameInstanceSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	if (UDataTable* DataTable = Cast<UDataTable>(StaticLoadObject(UDataTable::StaticClass(), nullptr, TEXT("/Script/Engine.DataTable'/Game/00_ProjectNA/04_DataTable/01_Ability/AttributesTable.AttributesTable'"))))
	{

...
void ANAItemInstance::PostInitProperties()
{
...
void ANAItemInstance::InitItemData_Internal()
{
	InitItemData_Impl();
	OnItemDataInitialized();
}

void ANAItemInstance::InitItemData_Impl()
{
	const bool bSucceed = TryCreateItemData<FNAItemBaseTableRow>();
	if (bSucceed) {

	}
}

void ANAItemInstance::OnItemDataInitialized_Implementation()
{
}
